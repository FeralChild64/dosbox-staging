...
#include "../mouse/mouse_internals.h"
          ...
          port_num(static_cast<uint16_t>(id + 1))
{
    ...
    param_model    = mouse_config.model_com[port_id];
    param_auto_msm = mouse_config.model_com_auto_msm[port_id];
